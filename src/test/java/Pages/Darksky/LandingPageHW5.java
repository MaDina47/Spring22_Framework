...
public class LandingPageHW5 extends Commands {
    ...
    public void scrollToTimeMachineBtnByPixel(){ scrollByPixel("1100");}
   ...
   // 2
    ...
    public void scrollToElIntoViewTodayBar(){
        scrollToElementIntoView(todayLocator);
    }

    public void scroll(){
        scrollToElement(todayLocator);
    }
